// $Id: constants.js 1684 2012-08-31 20:27:23Z wayne $

/***********************************
 *             Constants             *
 ***********************************/

const server_url = "www.law.cornell.edu/jureeka/index.php";
const organization_name = "Legal Information Institute";
...
const filters = [
  {
    ...
    regexp: /(U\.? ?S\.?) Const\.?,? ?(((a|A)rt\.?|(a|A)mend\.?|(p|P)mbl\.?|(p|P)reamble)( ?[XVI]+))?((, (\u00A7|S|&sect;|&#167) ([0-9]+)) ?(, cl\. ([0-9]+)\.?)?)?/ig,
  ...
  {
    name: "U.S. Code",
    regexp: /([0-9]+) U\.? ?S\.? ?C\.?( ?S\.?|A\.?)? (\u00A7|&sect;|&#167|section|sect?\.?)? ?(\d{1,6}(?:[a-zA-Z]{0,4}(?:\-\d{0,3}[a-zA-Z]?)?)?) ?((?:\([0-9a-zA-Z]\))+)? ?(?:\((\d{4})\))?/ig,
  ...
  },
  {
    ...
    regexp: /I\.? ?R\.? ?C\.? (?:\u00A7|&sect;|&#167|section|sect?\.?)? ?(\d{1,6}(?:[a-zA-Z]{0,4}(?:\-\d{0,3}[a-zA-Z]?)?)?) ?((?:\([0-9a-zA-Z]\))+)? ?(?:\((\d{4})\))?/ig,
  ...
  },
  {
    ...
    regexp: /([0-9]+) (C\.?F\.?R\.?) (\u00A7)? ?([0-9a-zA-Z\-]+)\.([0-9a-zA-Z\-]+) ?((?:\([0-9a-zA-Z]\))+)? ?(?:\((\d{4})\))?/ig,
    href: function(match) { return "http://" + server_url + "?doc=CFR&title=" + match[1] + "&part=" + match[4] + "." + match[5] + "&sec2=" + match[6] + "&year=" + match[7]; }
  },
  {
    ...
    href: function(match) { return "http://" + server_url + "?doc=CFR&title=" + match[1] + "&part=" + match[4] +"&sec=" + match[5] + "&sec2=" + match[6] + "&year=" + match[16]; }
  },
  {
    name: "Treasury Regulations",
    regexp: /Treas\.? ?Reg\.? ?(\u00A7|&sect;|&#167|section|sect?\.?|Parts?)* ?([0-9aA]+)/ig,
  ...
  },
  {
    ...
    href: function(match) { return "http://" + server_url + "?doc=FedSupp&cite=" + match[1]; }
  },
  {
    name: "Fed. R. Evid.",
  ...
  },
  {
    ...
    regexp: /(UCC|U\.C\.C\.|Uniform Commercial Code) ?(\u00A7|&sect;|&#167;|section|sect?\.?)* ?(([1-9A]+)-([0-9]+))/g,
  ...
  },
  {
    ...
    href: function(match) { return "http://" + server_url + "?doc=RegionalRptrs&vol=" + match[1] + "&rptr=" + match[2] + "&page=" + match[6]; }
  },
  ...
  // --------------------------------------------------------
  {
    ...
    regexp: /(Alabama|Ala\.?) ?Code (\u00A7|&sect;|&#167|section|sect?\.?)* ?(([0-9A]+)-([0-9a-z]+)-([-0-9a-z]+))/ig,
  ...
  },
  {
    ...
    regexp: /Alaska Stat(\.?|utes?) (\u00A7|&sect;|&#167|section|sect?\.?)* ?(([0-9]+).([0-9a-z]+).([-0-9a-z]+))/ig,
  ...
  },
  {
    ...
    regexp: /Ariz(\.?|ona) (Rev\.?)? ?Stat(\.?|utes?)( Ann\.?)? (\u00A7|&sect;|&#167|section|sect?\.?)* ?([0-9]+)-([-0-9A\.]+)/ig,
  ...
  {
    name: "Arkansas Code",
    regexp: /Ark(\.?|ansas) Code( Ann\.?)? (\u00A7|&sect;|&#167|section|sect?\.?)* ?(([0-9A]+)-([0-9a-z]+)-([-0-9a-z]+))/ig,
  ...
  },
  {
    ...
    regexp: /Colo(\.?|rado) (Rev\.?)? ?Stat(\.?|utes?)( Ann\.?)? (\u00A7|&sect;|&#167|section|sect?\.?)* ?([-0-9\.]+)/ig,
    href: function(match) { return "http://" + server_url + "?doc=ColoradoStatutes&prov=" + match[7]; }
  },
  {
    name: "Connecticut Statutes",
    regexp: /Conn(\.?|ecticut) ?Gen(\.?|eral) ?Stat(\.?|utes?)( Ann\.?)? (\u00A7|sect?\.?|&sect;|&#167|section)* ?([0-9]+a?)-([0-9a-z]+)/ig,
  ...
  {
    name: "Delaware Code",
    regexp: /Del(\.?|aware) ?Code ?( Ann\.?)?,? tit\.? ([0-9]+)(,? ?(\u00A7|&sect;|&#167|section|sect?\.?)* ?([-0-9]+))?/ig,
  ...
  },
  {
    ...
    regexp: /(F\.? ?S\.? ?A\.?|Fla\.? Stat\.?( Ann\.?)?) ?(\u00A7|&sect;|&#167|section|sect?\.?)* ?([0-9]+)\.([0-9]+)/ig,
  ...
  {
    name: "Georgia Code",
    regexp: /Ga\.? Code( Ann\.?)? ?(\u00A7|&sect;|&#167|section|sect?\.?)* ?([0-9]+)-([-0-9A\.]+)/ig,
  ...
  },
  {
    ...
    href: function(match) { return "http://" + server_url + "?doc=GACases&cite=" + match[1]; }
  },
  {
  ...
  {
    name: "Idaho Code",
    regexp: /Idaho Code ?(\u00A7|&sect;|&#167|section|sect?\.?)* ?([0-9]+)-([0-9]+)/ig,
  ...
  {
    name: "Indiana Code",
    regexp: /(I\.?C\.?|Ind(\.?|iana) ?Code ?(Ann(\.?|otated))?) ?(\u00A7|&sect;|&#167|section|sect?\.?)* ?(([0-9\.]+)-([0-9\.]+)-([0-9\.]+)-([0-9\.]+))/ig,
  ...
  },
  {
    ...
    href: function(match) { return "http://" + server_url + "?doc=IndianaCases&cite=" + match[0]; }
  },
  {
    name: "Iowa Code",
    regexp: /Iowa ?Code ?(Ann(\.?|otated))? ?(\u00A7|&sect;|&#167|section|sect?\.?)* ?([0-9]+([A-Z])?)\.([0-9])/ig,
  ...
  },
  {
    ...
    regexp: /(K\.?S\.?A\.?|Kan(\.?|sas) ?Stat\.? ?( Ann\.?)?) ?(\u00A7|&sect;|&#167|section|sect?\.?)? ?(([0-9a]+)-([0-9a]+)([\-0-9a-z,]+)?)[\(\)\w]+/ig,
    // href: function(match) { return "http://" + server_url + "?doc=KansasStatutes&ch=" + match[5] + "&sec=" + match[6]; }
    href: function(match) { return "http://" + server_url + "?doc=KansasStatutes&cite=" + match[5] + "&ch=" + match[6] + "&sec=" + match[7] + "&sec2=" + match[8]; }
  },
  {
    name: "Kansas Cases",
  ...
  },
  {
    ...
    regexp: /K(y\.|entucky) ?Rev(\.|ised) ?Stat(\.|utes) ?( Ann(\.|otated))? ?(\u00A7|&sect;|&#167|sect?\.?)* ?([0-9]+)([A-Z])?\.(([0-9]+)-)?([0-9a]+)/ig,
  ...
  {
    name: "Maine Statutes",
    regexp: /Me\.? ?Rev\.? ?Stat\.? ?(Ann\.?)?,? ?tit(\.?|le) ?([-0-9a-z]+),? (\u00A7|&sect;|&#167|section|sect?\.?)* ?([-0-9a-z]+)/ig,
  ...
  },
  {
    ...
    href: function(match) { return "http://" + server_url + "?doc=MDCases&cite=" + match[0]; }
  },
  {
    name: "Massachusetts General Laws",
    regexp: /Mass\.? ?Gen\.? ?Laws ?ch\.? ?([0-9A-Z]+),? ?(\u00A7|&sect;|&#167|section|sect?\.?)* ?([0-9]+)/ig,
  ...
  },
  {
    ...
    regexp: /Mich\.? ?Comp\.? ?Laws ?(Ann\.?)? ?(\u00A7|&sect;|&#167|section|sect?\.?)* ?([0-9\.]+)/ig,
  ...
  },
  {
    ...
    href: function(match) { return "http://" + server_url + "?doc=MichCases&cite=" + match[1]; }
  },
  {
  ...
  },
  {
    ...
    regexp: /Minn\.? ?Stat\.? ?(Ann\.?)? ?(\u00A7|&sect;|&#167|section|sect?\.?)* ?([0-9][0-9A-Z\.]+)/ig,
  ...
  },
  {
    ...
    regexp: /Miss\.? ?Code ?Ann\.? ?(\u00A7|&sect;|&#167|section|sect?\.?)* ?(([0-9]+)-([0-9]+)-([0-9]+))/ig,
    // href: function(match) { return "http://" + server_url + "?doc=MississippiCode&title=" + match[2] + "&ch=" + match[3] + "&sec=" + match[4]; }
    href: function(match) { return "http://" + server_url + "?doc=MississippiCode&cite=" + match[2] + "&title=" + match[3] + "&ch=" + match[4] + "&sec=" + match[5]; }
  },
  {
  ...
  {
    name: "Montana Code",
    regexp: /Mont\.? ?Code ?Ann\.? ?(\u00A7|&sect;|&#167|section|sect?\.?)* ?([0-9]+)-([0-9]+)-([0-9]+)/ig,
    href: function(match) { return "http://" + server_url + "?doc=MontanaCode&title=" + match[2] + "&ch=" + match[3] + "&sec=" + match[4]; }
  },
  {
    name: "Nebraska Statutes",
    regexp: /Neb(\.?|raska) ?Rev(\.?|ised) ?Stat(\.?|utes) ?(Ann\.?)? ?(\u00A7|&sect;|&#167|section|sect?\.?)* ?([0-9]+)-([0-9\.]+)/ig,
    href: function(match) { return "http://" + server_url + "?doc=NebraskaStatutes&title=" + match[6] + "&sec=" + match[7]; }
  },
  {
    name: "Nevada Statutes",
    regexp: /(N\.? ?R\.? ?S\.?|Nev\.? ?Rev\.? ?Stat\.? ?(Ann\.?)?) ?(\u00A7|&sect;|&#167|section|sect?\.?)* ?([0-9A-Z]+)\.([0-9\.]+)/ig,
    href: function(match) { return "http://" + server_url + "?doc=NevadaStatutes&title=" + match[4] + "&sec=" + match[5]; }
  },
  {
    name: "Nevada cases",
    regexp: /[0-9]+ Nev\.? [0-9]+/ig,
    href: function(match) { return "http://" + server_url + "?doc=NevadaCases&cite=" + match[0]; }
  },
  {
    name: "New Jersey Statutes",
    regexp: /(N\.?J\.?S\.?A\.?|N\.?J\.? Stat\.? Ann\.?) ?(\u00A7|&sect;|&#167|section|sect?\.?)* ?(([0-9a-b]+):([0-9a-b]+)-([0-9a-b\.]+))/ig,
    // href: function(match) { return "http://" + server_url + "?doc=NJSA&title=" + match[3] + "&sec=" + match[4] + "&subsec=" + match[5]; }
    href: function(match) { return "http://" + server_url + "?doc=NJSA&cite=" + match[3] + "&title=" + match[4] + "&sec=" + match[5] + "&subsec=" + match[6]; }
  },
  {
  ...
  },
  {
    ...
    regexp: /(N\.?M\.?S\.?A\.?|N\.?M\.? ?Stat\.? ?(Ann\.)?) ?(\u00A7|&sect;|&#167|section|sect?\.?)* ?([0-9a-z]+)-([0-9a-z]+)-([0-9a-z]+)/ig,
  ...
  },
  {
    ...
    href: function(match) { return "http://" + server_url + "?doc=NMReports&cite=" + match[0]; }
  },
  {
    name: "N.Y. C.P.L.R.",
  ...
  },
  {
    ...
    href: function(match) { return "http://" + server_url + "?doc=NYcases&cite=" + match[1]; }
  },
  {
    name: "North Carolina Statutes",
    regexp: /N\.? ?C\.? ?Gen\.? ?Stat\.?( ?Ann\.)? (\u00A7|S|&sect;|&#167|section|sect?\.?)* ?([0-9a-z]+)-([0-9\.a-z]+)/ig,
    href: function(match) { return "http://" + server_url + "?doc=NCstatutes&title=" + match[3] + "&ch=" + match[4]; }
  },
  {
    name: "North Carolina cases",
    regexp: /([0-9]+ (N\.? ?C\.? ?App\.?|N\.? ?C\.?) [0-9]+)/ig,
    href: function(match) { return "http://" + server_url + "?doc=NCcases&cite=" + match[1]; }
  },
  {
    name: "North Dakota Code",
    regexp: /N\.?D\.? ?Cent\.? ?Code (\u00A7|&sect;|&#167|section|sect?\.?)* ?([0-9\.]+)-([0-9\.]+)/ig,
  ...
  {
    name: "Ohio Code",
    regexp: /Ohio ?Rev\.? ?Code ?(Ann\.?)? ?(\u00A7|&sect;|&#167|section|sect?\.?)* ?([-0-9\.A]+)/ig,
    href: function(match) { return "http://" + server_url + "?doc=OhioCode&sec=" + match[3]; }
  },
  {
    name: "Ohio Administrative Code",
    regexp: /Ohio ?Admin\.? ?Code ?(\u00A7|&sect;|&#167|section|sect?\.?)* ?([-0-9\.:]+)/ig,
  ...
  },
  {
    ...
    href: function(match) { return "http://" + server_url + "?doc=OhioCases&cite=" + match[1]; }
  },
  {
    name: "Oklahoma Cases",
    regexp: /(19[0-9][0-9]|20[0-9][0-9]) OK [0-9]+/g,
    href: function(match) { return "http://" + server_url + "?doc=OKCases&cite=" + match[0]; }
  },
  {
    name: "Oregon Statutes",
    regexp: /Ore?(\.?|egon) ?Rev\.? ?Stat\.? ?(\u00A7|&sect;|&#167|section|sect?\.?)* ?([-0-9a-d]+)(.([0-9a-d]+))?/ig,
  ...
  },
  {
    ...
    href: function(match) { return "http://" + server_url + "?doc=ORCases&cite=" + match[0]; }
  },
  {
    name: "Pennsylvania Statutes",
    regexp: /([0-9]+) Pa\.?( ?C(ons)?\.?)? ?S(tat)?\.?( ?Ann\.)? ?(\u00A7|&sect;|&#167|section|sect?\.?)* ?([0-9]+)([0-9]{2})(\.([0-9]+))?/ig,
  ...
  },
  {
    ...
    regexp: /([0-9]+) Pa\.? ?Code ?(\u00A7|&sect;|&#167|section|sect?\.?)* ?([0-9]+)(\.([0-9]+))?/ig,
  ...
  },
  {
    ...
    href: function(match) { return "http://" + server_url + "?doc=PACases&cite=" + match[1]; }
  },
  {
  ...
  },
  {
    ...
    regexp: /R\.?I\.? ?Gen\.? ?Laws ?(\u00A7|&sect;|&#167|section|sect?\.?)* ?([0-9\.A]+)-([0-9\.]+)-([0-9\.]+)/ig,
  ...
  },
  {
    ...
    regexp: /R\.?I\.? ?Code ?R\.? ?(\u00A7|&sect;|&#167|section|sect?\.?)* ?([0-9\.A]+)-([-0-9\.]+)/ig,
    href: function(match) { return "http://" + server_url + "?doc=RICode&title=" + match[2] + "&sec=" + match[3]; }
  },
  {
    name: "South Carolina Codes",
    regexp: /S\.? ?C\.? ?Code (Ann\.?)? ?(Regs\.?)? ?(\u00A7|&sect;|&#167|section|sect?\.?)* ?([0-9\.A]+)-([0-9\.]+)(-([0-9\.]+))?/ig,
  ...
  },
  {
    ...
    href: function(match) { return "http://" + server_url + "?doc=SCCases&cite=" + match[0]; }
  },
  {
    name: "South Dakota Codified Laws",
    regexp: /S\.? ?D\.? ?Codified ?Laws ?(Ann\.?)? ?(\u00A7|&sect;|&#167|section|sect?\.?)* ?([-0-9a-z\.]+)?/ig,
    href: function(match) { return "http://" + server_url + "?doc=SDCodifiedLaws&cite=" + match[3]; }
  },
  {
    name: "Tennessee Code",
  ...
  {
    name: "Utah Code",
    regexp: /Utah Code ?Ann\.? ?(\u00A7|&sect;|&#167|section|sect?\.?)* ?([0-9]+)([a-z])?-([0-9]+)([a-z])?-([0-9]+)([a-z]+)?/ig,
  ...
  },
  {
    ...
    href: function(match) { return "http://" + server_url + "?doc=UtahCases&cite=" + match[0]; }
  },
  {
    name: "Vermont Statutes",
    regexp: /Vt\.? ?Stat\.? ?Ann\.?,? ?tit\.? ?([0-9A]+), ?(\u00A7|&sect;|&#167|section|sect?\.?)* ?([0-9]+)([a-z]+)?/ig,
    href: function(match) { return "http://" + server_url + "?doc=VTStatutes&title=" + match[1] + "&sec=" + match[3] + "&sec2=" + match[4]; }
  },
  {
  ...
  {
    name: "Vermont Code",
    regexp: /Vt\.? ?Stat\.? ?Ann\.? ?tit\.? ?([0-9A]+), ?(\u00A7|S|&sect;|&#167|(s|S)ection)* ?([0-9]+)([a-z]+)?/ig,
    href: function(match) { return "http://" + server_url + "?doc=VTCode&title=" + match[1] + "&sec=" + match[4] + "&sec2=" + match[5]; }
  },
  {
    name: "Virginia Code",
    regexp: /Va\.? ?Code ?Ann\.? ?(\u00A7|&sect;|&#167|section|sect?\.?)* ?([-0-9A\.:]+)/ig,
  ...
  },
  {
    ...
    regexp: /Wash\.? ?Rev\.? ?Code? ?(Ann\.?)? ?(\u00A7|&sect;|&#167|section|sect?\.?)* ?([0-9A-Z\.]+)/ig,
  ...
  },
  {
    ...
    href: function(match) { return "http://" + server_url + "?doc=WACases&cite=" + match[0]; }
  },
  {
    name: "Wisconsin Statutes",
    regexp: /Wis\.? ?Stat\.? ?(Ann\.?)? ?(\u00A7|&sect;|&#167|section|sect?\.?)* ?([0-9\.]+)/ig,
    // href: function(match) { return "http://" + server_url + "?doc=WIStatutes&&cite=" + match[3]; }
    href: function(match) { return "http://" + server_url + "?doc=WisconsinStatutes&cite=" + match[3]; }
  },
  {
    name: "Wisconsin Cases",
    regexp: /([0-9]+ (Wis\.? ?2d\.?|Wis\.?) [0-9]+)(,|\.|;| )/ig,
    href: function(match) { return "http://" + server_url + "?doc=WICases&cite=" + match[1]; }
  },
  {
    name: "Wisconsin Cases (public domain citation)",
    regexp: /([0-9]+ Wi\.?( ?App\.?)? [0-9]+)/ig,
    href: function(match) { return "http://" + server_url + "?doc=WICases&cite=" + match[0]; }
  },
  {
    name: "Miscellaneous Cases",
    regexp: /[0-9]+ (Haw\.? ?App\.?|Haw\.?|Hawaii|Idaho|Mont\.?|Neb\.? ?App\.?|Neb\.?|N\.? ?H\.?|W\.? ?Va\.?|B\.? ?R\.?) [0-9]+/ig,
    href: function(match) { return "http://" + server_url + "?doc=MiscCases&cite=" + match[0] + "&jur=" + match[1]; }
  },
  {
    name: "Public Domain Citations",	// Misc. small states
    regexp: /(19|20)[0-9][0-9] (ME|MT|ND|SD|VT|WY) [0-9]+/ig,
    href: function(match) { return "http://" + server_url + "?doc=PubDomCites&cite=" + match[0] + "&jur=" + match[2]; }
  },
  {
